...
| RF-08 | O sistema deve permitir ao usuário armazenar os livros em uma Estante.                                                                                                                                                            | MÉDIA      |
| RF-09 | O sistema deve permitir ao usuário buscar livros com PDF's gratuitos em uma Biblioteca                                                                                                                                            | MÉDIA      |
