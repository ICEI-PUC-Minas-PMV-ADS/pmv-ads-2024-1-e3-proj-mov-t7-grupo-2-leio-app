...
| Editor de código                           | Expo            | [Expo](https://snack.expo.dev/@lucasgdev/login-leio-app)                                                                                                                                                          |
...
- O <b>Expo</b> foi escolhido como editor de código por indicação dos microfundamentos.
